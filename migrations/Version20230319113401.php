 ...
 */
final class Version20230319113401 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE photo DROP category');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE photo ADD category VARCHAR(255) NOT NULL');
    }
}

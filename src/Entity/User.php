...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    private ?int $defaultNbPlaces = null;
    ...
    public function getDefaultNbPlaces(): ?int
    {
        return $this->defaultNbPlaces;
    }

    public function setDefaultNbPlaces(?int $defaultNbPlaces): self
    {
        $this->defaultNbPlaces = $defaultNbPlaces;
